<template>
  <VCard class="position-relative">
    ...
    <VCardText>
      ...
      <div class="mb-3">
        <h6 class="text-h6 text-wrap" :class="{ 'text-success': isCompleted }">
          <strong
            >{{ props.lista_seguimiento.principal }} *
            {{ props.lista_seguimiento.tramo }}</strong
          >
        </h6>
      </div>
      ...
      <div class="d-flex justify-space-between align-end">
        ...
        <div class="flex-grow-1">
          <div class="text-subtitle-1">
            {{ props.lista_seguimiento.eecc }} <br />
            {{ props.lista_seguimiento.ip_tramo || "Sin IP asignada" }}
          </div>
          ...
          <div class="text-body-1 mb-3">
            {{
              (Number(props.lista_seguimiento.avance_total) * 100).toFixed(2)
            }}% avanzado
          </div>
          ...
          <VBtn
            ...
            class="mt-2"
            icon="ri-tools-line"
            :disabled="!(props.lista_seguimiento.total_trabajo > 0)"
          />
          ...
          <VBtn
            ...
            :disabled="!(props.lista_seguimiento.cant_licencia > 0)"
          />
          ...
          <VBtn
            ...
            class="mt-2 ml-2"
            icon="ri-lock-line"
            :disabled="!(props.lista_seguimiento.cant_candado > 0)"
          />
        ...
        <!-- Columna Derecha lineas de porcentaje -->
        <div class="text-right" style="min-width: 120px">
          <div>
            <p class="text-caption mb-0">
              Licencia {{ props.lista_seguimiento.pct_licencias_entregadas }}%
            </p>
            <VProgressLinear
              :model-value="
                Number(props.lista_seguimiento.pct_licencias_entregadas)
              "
              color="secundary"
              height="8"
              rounded
          ...
          <div class="mt-2">
            <p class="text-caption mb-0">
              Tendido
              {{
                (Number(props.lista_seguimiento.av_tendidos) * 100).toFixed(2)
              }}%
            </p>
            <VProgressLinear
          ...
          <div class="mt-2">
            <p class="text-caption mb-0">
              Mufas {{ props.lista_seguimiento.pct_pasivos }}%
            </p>
            <VProgressLinear
          ...
          <div class="mt-2">
            <p class="text-caption mb-0">
              Pruebas {{ props.lista_seguimiento.pct_pruebas }}%
            </p>
            <VProgressLinear
...
const enviar_fftt = () => {
  emit("cargar_fftt", props.lista_seguimiento);
};
</script>
